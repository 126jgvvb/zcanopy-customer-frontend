...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--border)] bg-[var(--zcanopy-surface)]">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="font-sans text-xs font-semibold uppercase tracking-[0.16em]" style={{ color: COLORS.cardBrown }}>
              Company
            </h3>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-[var(--border)] pt-6 text-sm text-gray-500 sm:flex-row">
